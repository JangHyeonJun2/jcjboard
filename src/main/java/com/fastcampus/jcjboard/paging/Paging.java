...
public class Paging {
    ...
    private int totalCount; // 게시글 전체 수.(중요)
    ...
    private void makePaging() {
        ...
        // 현재 페이지가 마지막페이지보다 크면 안되니까.
        // 혹시 크다면~~~~ finalPage 를 현재 페이지no로 set 해줘라~
        ...
        // 10 이 pageSize
        int startPage = ((pageNo - 1)/10) * 10 +1; // 시작페이지 (1~10, 11~20, 21~30 에서 1,11,21을 나타냄???)
        int endPage = startPage + 10 -1; // 끝페이지.
